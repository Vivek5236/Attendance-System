...
export default function AdminAttendance() {
  ...
  const users = (usersData?.data || []).filter(u => u.role === 'employee')
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <div className="page-title">All Attendance</div>
          <div className="page-sub">System-wide attendance records</div>
        </div>
      </div>
      ...
      <div className="filters">
        ...
        <button className="btn btn-primary" onClick={() => setApplied({ ...filters })}>Apply</button>
        <button className="btn btn-secondary" onClick={() => { setFilters({ startDate: '', endDate: '', userId: '' }); setApplied({}) }}>Clear</button>
      </div>
